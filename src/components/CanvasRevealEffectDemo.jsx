...
export function CanvasRevealEffectDemo() {
  return (<>
    <div
      className="flex flex-col items-center justify-center w-full gap-4 px-8 py-20 mx-auto bg-white lg:flex-row dark:bg-black">
...
const Card = ({
  ...
  return (
    (<div
      ...
      <Icon
        className="absolute w-6 h-6 text-black -bottom-3 -right-3 dark:text-white" />
      <AnimatePresence>
        {hovered && (
          <motion.div
            initial={{ opacity: 0 }}
